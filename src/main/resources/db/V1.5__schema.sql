...
CREATE TABLE IF NOT EXISTS `dept_accesscontrol_auth`(
  ...
  `dept_id` varchar(48) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '部门id',
...
CREATE TABLE IF NOT EXISTS `dept_face_auth`(
  ...
  `face_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '人脸id',
  PRIMARY KEY (`id`) USING BTREE
