...
public class LoginFaceRecognitionController {
    ...
    @ApiOperation(value = "通过app登录获取智能锁编码解析")
    ...
    public RestfulEntityBySummit<List<LockInfo>> lockCodeParse(@RequestBody List<String> lockCodes) {
        try {
            ...
            return ResultBuilder.buildError(ResponseCodeEnum.CODE_9999, "通过app登录获取智能锁编码解析失败", null);
        }
    }

    @ApiOperation(value = "通过app登录获取智能锁密码")
    ...
    public RestfulEntityBySummit<LockInfo> lockCodePassword(@RequestBody GetLockCodeParam getLockCodeParam) {
        try {
            ...
            return ResultBuilder.buildError(ResponseCodeEnum.CODE_9999, "通过app登录获取智能锁密码失败", null);
        }
    }

    @ApiOperation(value = "通过app登录提交智能锁开锁结果")
    ...
    public RestfulEntityBySummit<String> unlockResult(@RequestBody UnlockResultInfo unlockResultInfo) {
        try {
            ...
            log.error(e.getMessage(),e);
            return ResultBuilder.buildError(ResponseCodeEnum.CODE_9999, "通过app登录提交智能锁开锁结果失败", null);
        }
    }
