...
public class RealDataLinuxCallBack implements HWPuSDKLinuxLibrary.pfRealDataCallBack {
    ...
    private FaceInfo procBuffer(Pointer szBuffer, NativeLong lSize, int layerTwoType, FaceInfo faceInfo) {
        ...
        HWPuSDKLinuxLibrary.INSTANCE.IVS_User_GetMetaData(szBuffer, lSize, layerTwoType, pu_meta_data_pointer_pointer);
        faceInfo = procMetaData(pu_meta_data_pointer_pointer, faceInfo);
        HWPuSDKLinuxLibrary.INSTANCE.IVS_User_FreeMetaData(pu_meta_data_pointer_pointer);
        return faceInfo;
    }
