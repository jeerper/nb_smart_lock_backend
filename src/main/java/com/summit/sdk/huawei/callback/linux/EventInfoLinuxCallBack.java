package com.summit.sdk.huawei.callback.linux;
...
@Slf4j
public class EventInfoLinuxCallBack implements HWPuSDKLinuxLibrary.pfGetEventInfoCallBack {
    ...
    private HWPuSDKLinuxLibrary.pfGetAlarmInfoCallBack pfGetAlarmInfoCallBack;
    private HWPuSDKLinuxLibrary.pfRealDataCallBack pfRealDataCallBack;


    public EventInfoLinuxCallBack(long sdkPort, String sdkUserName, String sdkPassword, String sdkLocalhost,
        ...
        this.pfGetAlarmInfoCallBack = new AlarmInfoLinuxCallBack();
        this.pfRealDataCallBack = new RealDataLinuxCallBack(clientFaceInfoCallback);
    }
    ...
    public void apply(PU_EVENT_COMMON arg) {
        switch (arg.enEventType) {
            ...
            case HWPuSDKLibrary.PU_EVENT_TYPE.PU_EVENT_TYPE_REGISTER:
                ...
                boolean responseRegisterStatus = HWPuSDKLinuxLibrary.INSTANCE.IVS_PU_ResponseDeviceRegister(arg.ulIdentifyID,
...
//                log.debug("告警上报回调函数绑定:" + alarmCallBackBindStatus);
                ...
                NativeLong realDataCallBackBindStatus = HWPuSDKLinuxLibrary.INSTANCE.IVS_PU_RealPlay(arg.ulIdentifyID, realPlayInfo,
            ...
            case HWPuSDKLibrary.PU_EVENT_TYPE.PU_EVENT_TYPE_UNREGISTER:
                log.debug("设备主动注销");
                HWPuSDKLinuxLibrary.INSTANCE.IVS_PU_StopAllRealPlay(arg.ulIdentifyID);
                HWPuSDKLinuxLibrary.INSTANCE.IVS_PU_Logout(arg.ulIdentifyID);
